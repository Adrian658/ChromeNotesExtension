function convertHtmlToRtf(html) {
    ...
    // Empty tags
    richText = richText.replace(/<(?:p|div|section|article|h1|h2)(?:\s+[^>]*)?\s*[\/]>/ig, "{\\pard\\par}\n");
    ...
    richText = richText.replace(/<(?:h1)(?:\s+[^>]*)?>/ig, "{\\pard\n{\\fs48\n");
    richText = richText.replace(/<(?:h2)(?:\s+[^>]*)?>/ig, "{\\pard\n{\\fs36\n");
    ...
    richText = richText.replace(/&(?:#65279|nbsp)(?:\s+[^>]*)?;/ig, "");
  
    // End tags
    richText = richText.replace(/<\/(?:p|div|section|article)(?:\s+[^>]*)?>/ig, "\n\\par}\n");
    richText = richText.replace(/<\/(?:h1|h2)(?:\s+[^>]*)?>/ig, "\n}\n\\par}\n");
